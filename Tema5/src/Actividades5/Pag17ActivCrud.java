...
public class Pag17ActivCrud {
    ...
    public static void main(String[] args) {
        ...
        Pag17ActivCrud objeto = new Pag17ActivCrud();
        
        //Lectura de datos
        objeto.leerDatos("Tema5/src/numeros.txt");
        System.out.println("Victorias jugador1= " 
                + objeto.getPartidasJugador1() + ". Victorias jugador2= "
    ...
    //Función para borrar el contenido del fichero (reset de partidas)
    public void borrarPartida(String ruta) {
        try {
            //Al abrir FileWriter sin append, el fichero se vacía
            BufferedWriter bw = new BufferedWriter(new FileWriter(ruta));
            bw.close();
